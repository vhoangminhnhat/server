...
import { DocumentRepositoryToken } from '@/aiEmbedding/shared/tokens/documents/DocumentRepository.token';
import { okResponse } from '@/common/models/apiResponse.model';
import { BadRequestException, Inject, Injectable } from '@nestjs/common';
import { randomUUID } from 'crypto';
import { AiDocument } from '../domains/entities/AiDocument.entity';
import { AiDocumentChunk } from '../domains/entities/AiDocumentChunk.entity';
import { IDocumentRepository } from '../domains/repositories/DocumentRepository.interface';
import { ImportAiDocumentDto } from '../presentations/dtos/ImportAiDocument.dto';
